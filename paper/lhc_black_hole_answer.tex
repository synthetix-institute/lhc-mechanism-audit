...
\small
\begin{tabularx}{\linewidth}{p{0.28\linewidth}rX}
\toprule
Constructor-layer object & Count & Meaning\\
\midrule
fingerprinted equation windows & 1,408 & retained formula windows carrying route profiles and constructor-role evidence\\
sources with equation windows & 241 & papers represented in the retained fingerprinted equation layer\\
matched graph nodes & 1,408 & constructor equations linked to equation-mechanism graph nodes\\
slot-matched equations & 986 & formula windows that instantiate at least one physical constructor slot\\
case-relevant equations & 412 & slot or route evidence connected to the LHC black-hole question\\
source-local constructor chains & 241 & ordered equation sequences retained inside individual sources\\
\bottomrule
\end{tabularx}
\end{table}

This layer is the bridge between the raw equation graph and the physical
verdict. It contains 986
slot-matched equations and 412
