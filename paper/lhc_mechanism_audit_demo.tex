...
\begin{itemize}
\item Sparse attention supports the main audit finding: direct collider-safety mechanisms are absent under the strict gate, while adjacent astrophysical black-hole mechanisms are present.
\item Collider-threshold evidence appears as a separate branch from accretion, evaporation and capture mechanisms.
\item Evidence-grade case nodes concentrate on spectral\_operator (34), constraint\_closure (33), transport\_flow (25), consistent with mechanism translation rather than claim provenance.
\item Astrophysical analogues are routed mainly through spectral\_operator (28), constraint\_closure (27), transport\_flow (21), boundary\_weak\_form (3).
\end{itemize}
